...
export const Update = ({update,cancel,fname,setFname,lname,setLname,email,setEmail,id,setId}) => {
  return (
    <div className='ADD'>
      <br></br>
      ...
      <div className="container mt-5 " id='border'>
        ...
        <div className="form-floating">
          ...
          <button className="btn btn-success button" onClick={update} >Update</button>
